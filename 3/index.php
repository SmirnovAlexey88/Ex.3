...
$availableLanguages = array('Pascal', 'C', 'C++', 'JavaScript', 'PHP', 'Python', 'Java', 'Haskel', 'Clojure', 'Prolog', 'Scala');
...
$user = 'u67376';
$pass = '2209918';
$db = new PDO('mysql:host=localhost;dbname=u67376', $user, $pass, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
